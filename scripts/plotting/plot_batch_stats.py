...
def create_histogram_num_graphs_dynamic(
    ...
    plt.tight_layout()
    plt.savefig('batching_paper/figs/batch_stats_num_graphs_before_batching_size_32_aflow.png', dpi=600)
    plt.show()
...
def create_histogram(
    ...
    plt.tight_layout()
    plt.savefig(f'batching_paper/figs/batch_stats_{batch_stats_col}_size_{str(batch_size)}_{dataset}.png', dpi=600)
    plt.show()
...
def create_nodes_and_edges_histogram(base_dir, model_type='MPEU',
    ...
    fig.align_labels()
    plt.tight_layout()
    plt.savefig(f'batching_paper/figs/batch_stats_nodes_edges_size_{str(batch_size)}_{dataset}.png', dpi=600)
    plt.show()
...
def main(argv):
    # base_dir = 'tests/data'
    base_dir = 'jraph_MPEU/data/batch_stats_data_dec_18_2024/u/dansp/batch_stats/batching_stats_mpeu_qm9_aflow'
